...
function buildPayloads(docs) {
    return {
        ...
        orders: byType(docs, 'order').map(doc => ({
            ...
            created_at_business: toTimestamp(doc.createdAt),
            created_by: resolveSeedUserRef(docs, doc.createdBy),
            extra_data: omitKeys(doc, ['_id', '_type', '_createdAt', '_updatedAt', 'masterResi', 'cargoEntryMode', 'customerRef', 'customerName', 'receiverName', 'receiverPhone', 'receiverAddress', 'pickupAddress', 'serviceRef', 'serviceName', 'status', 'notes', 'createdAt', 'createdBy']),
        })),
        ...
        delivery_orders: byType(docs, 'deliveryOrder').map(doc => ({
            ...
            pickup_address: toText(doc.pickupAddress),
            notes: toText(doc.notes),
            extra_data: omitKeys(doc, ['_id', '_type', '_createdAt', '_updatedAt', 'doNumber', 'orderRef', 'masterResi', 'customerRef', 'vehicleRef', 'vehiclePlate', 'driverRef', 'driverName', 'date', 'status', 'trackingState', 'trackingStartedAt', 'trackingStoppedAt', 'trackingLastSeenAt', 'trackingLastLat', 'trackingLastLng', 'customerName', 'receiverName', 'receiverAddress', 'pickupAddress', 'notes']),
        })),
        delivery_order_items: byType(docs, 'deliveryOrderItem').map(doc => ({
            ...
            extra_data: omitKeys(doc, ['_id', '_type', '_createdAt', '_updatedAt', 'deliveryOrderRef', 'orderItemRef', 'orderItemDescription', 'orderItemQtyKoli', 'orderItemWeight', 'shippedQtyKoli', 'shippedWeight', 'actualQtyKoli', 'actualWeightKg']),
        })),
        ...
        freight_nota_items: byType(docs, 'freightNotaItem').map(doc => ({
            ...
            uang_rp: toNumber(doc.uangRp) ?? 0,
            ket: toText(doc.ket),
            extra_data: omitKeys(doc, ['_id', '_type', '_createdAt', '_updatedAt', 'notaRef', 'doRef', 'deliveryOrderItemRef', 'doNumber', 'vehiclePlate', 'date', 'noSJ', 'dari', 'tujuan', 'barang', 'collie', 'beratKg', 'tarip', 'uangRp', 'ket']),
        })),

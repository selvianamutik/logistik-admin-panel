...
function buildPayloads(docs) {
    return {
        ...
        services: byType(docs, 'service').map(doc => ({
            ...
            active: toBoolean(doc.active, true),
            extra_data: omitKeys(doc, ['_id', '_type', '_createdAt', '_updatedAt', 'code', 'name', 'description', 'maxPayloadKg', 'overtonaseDriverRatePerKg', 'active']),
        })),
        ...
        vehicles: byType(docs, 'vehicle').map(doc => ({
            ...
            service_ref: toText(doc.serviceRef),
            status: toText(doc.status),
            extra_data: omitKeys(doc, ['_id', '_type', '_createdAt', '_updatedAt', 'unitCode', 'plateNumber', 'vehicleType', 'brandModel', 'year', 'capacityKg', 'serviceRef', 'status']),
        })),
        ...
        maintenances: byType(docs, 'maintenance').map(doc => ({
            ...
            extra_data: omitKeys(doc, ['_id', '_type', '_createdAt', '_updatedAt', 'vehicleRef', 'vehiclePlate', 'type', 'scheduleType', 'plannedDate', 'plannedOdometer', 'status', 'completedDate', 'odometerAtService', 'vendor', 'notes', 'completionNotes', 'attachmentUrls', 'materialUsages', 'materialUsageCount', 'materialCostTotal', 'totalCost', 'relatedExpenseRef', 'cost']),
        })),
